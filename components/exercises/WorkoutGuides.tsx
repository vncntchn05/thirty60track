...
const MUSCLE_SPOTLIGHT: Record<string, MuscleSpotlight> = {
  ...
  Hands: {
    pplDay: 'All days — grip is trained indirectly on every pulling and pushing movement',
    upperLowerDay: 'Both days — grip engages on every compound lift',
    fullBodyNote: 'Add 2 direct grip/wrist sessions per week; farmers carries and dead hangs pair well with back days',
    primaryExercises: ['Dead Hang', 'Farmers Carry', 'Wrist Curl', 'Plate Pinch', 'Wrist Roller'],
  },
  Feet: {
    pplDay: 'Leg day — include ankle mobility and calf work',
    upperLowerDay: 'Lower day',
    fullBodyNote: 'Intrinsic foot strength improves with single-leg work and calf raises; add short foot exercise 3×/week',
    primaryExercises: ['Single-Leg Calf Raise', 'Ankle Alphabet', 'Towel Toe Scrunches', 'Short Foot Exercise', 'Tibialis Raise'],
  },
};
