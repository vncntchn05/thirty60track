...
function Field({
  ...
  return (
    <View style={[styles.field, { borderBottomColor: t.border }]}>
      ...
      <TextInput
        style={[styles.fieldInput, { color: t.textPrimary }, multiline && styles.fieldInputMulti]}
        value={value}
  ...
  return (
    ...
    >
      ...
      <View style={[styles.section, { backgroundColor: t.surface, borderColor: t.border }]}>
        ...
        <Field label="Date of birth"  value={fields.date_of_birth} onChange={(v) => set('date_of_birth', v)} placeholder="YYYY-MM-DD" autoCapitalize="none" />
