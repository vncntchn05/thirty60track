...
const TRAINER_FEATURES: FeatureGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'Log a Workout',
        description: 'Multi-exercise builder with sets, reps, weight, per-set rest timer, calorie estimates, and a workout summary on save.',
        route: null,
      ...
      },
      {
        icon: 'ribbon-outline',
        title: 'Workout Grade',
        description: 'Every logged workout receives an A+–F letter grade based on volume vs best, PRs hit, and rolling 4-session average.',
        route: null,
        routeLabel: 'Client detail → Workout detail',
      },
      {
        icon: 'clipboard-outline',
        title: 'Assign a Workout',
        description: 'Schedule workout programs for a client with a date, prescribed rest per exercise, and instructions.',
        route: null,
      ...
      },
      {
        ...
        description: 'Create weekly or biweekly workout series on selected days of the week; cancel the full series or individual instances.',
      ...
      },
      {
        ...
        description: 'All-time best weight and reps per client per exercise — auto-upserted on save, shown on the Progress tab.',
        route: null,
    ...
    items: [
      {
        ...
        description: 'Ask about program design, progressive overload, splits, warm-ups, deload, exercise substitutions, client retention, and nutrition.',
        route: '/(tabs)/messages',
        routeLabel: 'Messages → AI Training Assistant',
      },
      {
        icon: 'flash-outline',
        title: 'AI Workout Generator',
        description: 'Generates two personalised workout templates from a client\'s goals, injuries, training frequency, and workout history.',
        route: null,
        routeLabel: 'Log Workout → Use Template → Generate',
      },
      {
        icon: 'document-outline',
        title: 'Import from Notes',
        description: 'Paste free-form workout notes ("Bench 3×8 185lbs") and the AI pre-populates all exercise blocks and sets.',
        route: null,
        routeLabel: 'Log Workout → Import from Notes',
      },
      {
        icon: 'nutrition-outline',
        title: 'AI Nutrition Guide',
        description: 'Generate a personalised nutrition guide per client: calorie & macro targets, meal timing, foods to prioritise/avoid, and supplements.',
        route: null,
        routeLabel: 'Client detail → Nutrition → Guide',
      },
      {
        icon: 'restaurant-outline',
        title: 'AI Meal Plan',
        description: 'Generate a structured weekly meal plan with named meals, per-meal macro breakdowns, supplement schedule, and swap suggestions.',
        route: null,
        routeLabel: 'Client detail → Nutrition → Plan',
      },
      {
        icon: 'sparkles-outline',
        title: 'AI Fitness Trends',
        description: 'Daily AI-generated fitness trend summaries with article links, cached per day.',
        route: '/(tabs)/feed',
        routeLabel: 'Feed → Trends',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: 'Post updates, react (👍🔥👏), comment, and attach exercises, workouts, guides, or assigned workouts.',
        route: '/(tabs)/feed',
        routeLabel: 'Feed tab',
      },
      {
        ...
        title: 'Messaging',
        description: 'Direct messages with workout, exercise, and guide attachments. Generate a Jitsi video call link from any conversation.',
        route: '/(tabs)/messages',
    ...
    items: [
      {
        ...
        description: '280+ exercises with muscle groups, equipment, form cues, verified tutorial videos, and alternative exercise links.',
      ...
      },
      {
        ...
        description: 'Trainer-editable fitness encyclopaedia across 9 topics (PPL, Full Body, Progressive Overload, Warm-Up, Deload & more).',
        route: '/(tabs)/exercises',
  ...
  },
  {
    ...
    items: [
      {
        icon: 'nutrition-outline',
        title: 'Nutrition Logging & Recipes',
        description: 'Per-client food logging (1M+ foods via USDA + Open Food Facts), macro goals, and recipe templates with full macro breakdowns.',
        route: null,
        routeLabel: 'Client detail → Nutrition tab',
      },
      {
        icon: 'chatbox-outline',
        title: 'Client Nutrition Chat',
        description: 'Configure each client\'s cheat meal cadence from the Chat tab on their Nutrition screen.',
        route: null,
        routeLabel: 'Client detail → Nutrition → Chat',
      },
      {
        icon: 'people-circle-outline',
        title: 'Family Account Linking',
        description: 'Link client accounts into a family group — all members share workout tracking, nutrition, and credits.',
        route: null,
        routeLabel: 'Client detail → Family tab',
      },
      {
        icon: 'qr-code-outline',
        title: 'Master Check-In QR Code',
        description: 'Print the master gym QR code from your Profile tab. Clients scan it to self-check-in. All visits appear on their Check-ins tab.',
        route: '/(tabs)/profile',
...
const CLIENT_FEATURES: FeatureGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        icon: 'trophy-outline',
        title: 'Personal Records',
        description: 'Your all-time best weight and reps per exercise, tracked automatically every time you save a workout.',
        route: '/(client)/',
        routeLabel: 'Home → Progress tab',
      },
      {
    ...
    items: [
      {
        ...
        description: 'Browse all your logged training sessions with full set details and workout grade.',
      ...
      },
      {
        ...
        description: 'Trainer-assigned programs you can execute with one tap — pre-filled sets, prescribed rest timers, and calorie estimates.',
        route: '/(client)/workouts',
        routeLabel: 'Workouts tab',
      },
      {
        ...
        description: 'Record a session yourself using the multi-exercise builder with rest timers and a workout summary on save.',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'Gym Check-In',
        description: "Scan the master QR code posted at the gym (or tap 'Check In at the Gym' on your Profile) to instantly log your visit.",
    ...
    items: [
      {
        ...
        routeLabel: 'Nutrition → Log tab',
      },
      {
        icon: 'fitness-outline',
        title: 'Nutrition Guide',
        description: 'View your trainer-generated calorie and macro targets, meal timing, foods to prioritise, and supplement recommendations.',
        route: '/(client)/nutrition',
        routeLabel: 'Nutrition → Guide tab',
      },
      {
        icon: 'calendar-number-outline',
        title: 'Meal Plan',
        description: 'View your structured weekly meal plan with named meals, per-meal macro breakdowns, and a supplement schedule.',
        route: '/(client)/nutrition',
        routeLabel: 'Nutrition → Plan tab',
      },
      {
        icon: 'chatbubbles-outline',
        title: 'AI Nutrition Assistant',
        description: 'Ask about meals, fast food picks, recipes, supplements, and workout recovery — personalised to your macros and training history. Includes a cheat meal tracker.',
        route: '/(client)/messages',
        routeLabel: 'Messages → AI Nutrition Assistant',
      },
      {
        icon: 'restaurant-outline',
        title: 'Recipes',
        description: 'Access trainer-provided recipe templates with ingredient search and full macro breakdowns.',
        route: '/(client)/nutrition',
        routeLabel: 'Nutrition → Log tab → Recipes',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: 'chatbubble-outline',
        title: 'Messaging',
        description: 'Chat with your trainer, share workouts or exercises as attachments, and generate a video call link from any conversation.',
        route: '/(client)/messages',
        routeLabel: 'Messages tab',
      },
      {
        icon: 'barbell-outline',
        title: 'Exercise Library',
        description: 'Browse 280+ exercises with muscle groups, form cues, tutorial videos, and alternative exercise links.',
      ...
      },
      {
        icon: 'book-outline',
        title: 'Workout Guides',
        description: 'Read trainer-curated guides on PPL, Full Body, Progressive Overload, Warm-Up, Deload, and more.',
        route: '/(client)/exercises',
        routeLabel: 'Exercises → Guides tab',
      },
    ],
    ...
    items: [
      {
        ...
        description: 'View and log workouts or nutrition for linked family members from your home screen.',
        route: '/(client)/',
        routeLabel: 'Home',
      },
    ],
